...
This guide presents a collection of best-practices and coding conventions for the [CoffeeScript][coffeescript] programming language, with adjustments for use in the Primer project.

This guide is intended to be team-driven, and contributions are highly encouraged. Please create a new pull request with recommended changes and send it out via email to dev@goprimer.com.

Please note that this is a work-in-progress: there is much more that can be specified, and some of the guidelines that have been specified may not be deemed to be idiomatic by the community (in which case, these offending guidelines will be modified or removed, as appropriate).

## Inspiration

This guide was worked from: https://github.com/polarmobile/coffeescript-style-guide
...
Use commas before newlines when properties or elements of an Object or Array are listed on separate lines.
...
When calling functions, include parentheses for readability:

```coffeescript
# Yes
baz(12)
brush.ellipse({x: 10, y: 20}) # Braces should also be included for readability
foo(4).bar(8)
...
2. Get Sublime-linter (via Package Control) http://www.sublimelinter.com/en/latest/installation.html
...
3. Get node package manager: ```brew install node```

4. Get Coffeelint: ```npm install -g coffeelint```

5. Get Coffeelint-Sublime: https://github.com/SublimeLinter/SublimeLinter-coffeelint
...
When the plugin list appears, type coffeelint. Among the entries you should see SublimeLinter-coffeelint. If that entry is not highlighted, use the keyboard or mouse to select it.

6. Open Command Palette: Turn on SublimeLinter: Show Errors on Save
